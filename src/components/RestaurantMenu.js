...
const RestaurantMenu = () => {
  ...
  const handleCart = (item) => {
    // ON click of Add, dispatch an action
              ...
              >
                ...
                <div className="flex-1 pr-6">
                  <div className="flex items-center gap-2 mb-1">
                    <span
                      className={`text-[10px] border px-1 rounded-sm ${
                        item.is_veg
                ...
                <div className="relative flex flex-col items-center">
                  ...
                  <button
                    className="absolute -bottom-2 bg-white text-green-600 font-bold px-8 py-2 rounded-lg shadow-md border border-gray-200 hover:bg-gray-50 transition-all active:scale-90 uppercase text-xs"
                    onClick={() => handleCart(item)} //passing the event/ arg onClick of Add
                  >
                    Add+
                  </button>
                </div>
